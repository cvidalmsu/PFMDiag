...
public class ChocoMinimalOneProductQuestion extends ChocoQuestion implements
		OneProductQuestion {

	private Product prod;

	public ChocoMinimalOneProductQuestion() {
	}
	...
	public PerformanceResult answer(Reasoner choco) {
		...
		solver.setCpuTimeLimit(1800000);
		solver.minimize(solver.getVar(suma), false);
