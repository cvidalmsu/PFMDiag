...
public class SATFMDiag extends  Sat4jQuestion implements ExplainErrorsQuestion {
	...
	public PerformanceResult answer(Reasoner r) throws FAMAException {
		...
		//Instantiating it for configuration extension
		S.addAll(configurationConstraints.keySet());
		...
		for (String s : fmdiag) {
			result.put(s, configurationConstraints.get(s));
		}
	...
	private boolean isConsistentFAMA(Collection<String> aC) {
		//Model p = new CPModel();
		Model p = new  CPModel();
